...
namespace SmartBox.Console.Bo
{
    ...
    public class MonitorDefindBO : SmartBox.Console.Bo.BaseBO<Monitor_Defind>
    {
        ...
        public MonitorDefindBO()
        {
            base._dao = this.Monitor_DefindDao;
        }

        private Monitor_DefindDao _Monitor_DefindDao;
        protected Monitor_DefindDao Monitor_DefindDao
        {
            get
            {
                if (_Monitor_DefindDao == null)
                {
                    _Monitor_DefindDao = new Monitor_DefindDao(AppConfig.statisticDBKey);
                }
                return _Monitor_DefindDao;
            }
        }
