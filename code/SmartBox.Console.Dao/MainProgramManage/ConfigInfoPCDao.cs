...
{
    public class ConfigInfoPCDao : BaseDao<ConfigInfoPC>
    {
        /// <summary>
        /// 构造方法
        /// </summary>
        /// <param name="key">数据库链接字符串</param>
        public ConfigInfoPCDao(string key)
            : base(key)
        {
        ...
        {
            string sql = "delete from ConfigInfoPC where 1=1 " + GetQueryCondition(search);
        ...
        public IList<ConfigInfoPC> GetConfigList(SearchConfig search)
        {
