        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td>
                        <select id="selApp" class="easyui-combobox" data-options="panelHeight:'auto'" name="state" style="width:184px;">
                        <option value="">请选择</option>
		                <option value="ENABLE">通讯录</option>
		                <option value="DISABLE">日程</option>
                        <option value="DISABLE">移动办公</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <option value="">请选择</option>
		                <option value="ENABLE">审核已通过</option>
		                <option value="DISABLE">审核未通过</option>
                        <option value="DISABLE">待审核</option>
                        </select>
                    </td>
                    <td>单位：</td>
...
<a id="btn_upload" onclick="javascript:;" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">审核通过</a>
<a onclick="javascript:;" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">拒绝通过</a>

</div>
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetAppPackageAuthorizationList") %>',idField:'id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb',loadFilter: function (data) {
				...
				<thead>
					<tr>
                        ...
                        <th data-options="field:'packagename'" width="100">APP名</th>
                        <th data-options="field:'clienttype'" width="30">客户端</th>
                        <th data-options="field:'appname'" width="50">应用名称</th>       
                        <th data-options="field:'unitname'" width="60">单位</th>                   
                        <th data-options="field:'submit_time'" width="50">提交时间</th>                        
                        <th data-options="field:'cate'" width="30">类别</th>
                        <th data-options="field:'tj'" width="30">推荐</th>
                        <th data-options="field:'bb'" width="30">必备</th>
                        <th data-options="field:'status'" width="30">审核状态</th>
						<th data-options="field:'id2',formatter: function(value,row,index){
				return '<a href=\'#\' onclick=\'javascript:return void('+value+');\'>审核通过</a>' + 
                '&nbsp;<a href=\'#\' onclick=\'javascript:return void('+value+',&quot;AddJobPluginGroup&quot;)\'>拒绝通过</a>' + 
