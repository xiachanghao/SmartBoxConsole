...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:163px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>用户审核>>用户重试锁定</span>
        </div>
...
<%--<a onclick="javascript:return DeleteDll();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">锁定</a>--%>
     ...
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetUserRetryLockList") %>',idField:'pd_id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb'">
				<thead>
					<tr>
                        <th data-options="field:'pd_id',checkbox:true"></th>
						<th data-options="field:'username'" width="50">姓名</th>
                        <th data-options="field:'useruid'" width="180">账号</th>
                        <th data-options="field:'unit'" width="180">单位</th>
                        <th data-options="field:'retrycount'" width="80">重试次数</th>
                        <th data-options="field:'locktime'" width="180">锁定时间</th>
                        <th data-options="field:'user_status'" width="40">状态</th>
