...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:163px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>用户审核>>设备重试锁定</span>
        </div>
...
<a id="btn_upload" onclick="javascript:;" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">解除锁定</a>
<a onclick="javascript:;" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">锁定</a>
</div>
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetDeviceRetryLockList") %>',idField:'pd_id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb'">
				<thead>
					<tr>
                        ...
                        <th data-options="field:'unit'" width="130">单位</th>
                        <th data-options="field:'deviceno'" width="250">设备号</th>
                        <th data-options="field:'devicedesc'" width="180">设备描述</th>
                        <th data-options="field:'retrycount'" width="50">重试次数</th>
                        <th data-options="field:'locktime'" width="120">锁定时间</th>
                        <th data-options="field:'user_status'" width="50">状态</th>
						<th data-options="field:'pdid',formatter: function(value,row,index){
				return '<a href=\'#\' onclick=\'javascript:return test('+value+');\'>解除锁定</a>' + 
                '&nbsp;<a href=\'#\' onclick=\'javascript:return test('+value+',&quot;AddJobPluginGroup&quot;)\'>锁定</a>' + 
