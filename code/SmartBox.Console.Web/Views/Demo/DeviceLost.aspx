...
<a onclick="javascript:return void();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">挂失发布</a>
</div>
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetDeviceLost") %>',idField:'deviceid',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:false,toolbar: '#tb',loadFilter: function (data) {
			...
			<tr><th data-options="field:'deviceid2',checkbox:true"></th><th data-options="field:'deviceid3',formatter: function(value,row,index){
				...
				<thead>
					<tr>
                        ...
                        <th data-options="field:'model',sortable:true" width="220">设备型号</th>
