...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:195px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>设备管理>>设备管理</span>
        </div>
            ...
            if (item_length > 10) {
               // $('div[id^=\'_easyui_combobox_i2_\']').parent().parent().css('panelHeight',100);
                ...
                <tr style="display:;">
                    ...
                    <td>
                        <select id="selDeviceUserStatus" class="easyui-combobox" data-options="panelHeight:'auto'" name="selDeviceUserStatus" style="width:184px;">
                        <option value="">请选择</option>
...
<%--<a onclick="javascript:return void();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">解除绑定</a>--%>
     ...
     <table id="grid" class="easyui-datagrid" sortName=losttime sortOrder=desc style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetDeviceManage") %>',idField:'deviceid',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:false,toolbar: '#tb',loadFilter: function (data) {
                            for (var i = 0; i < data.rows.length; ++i) {
                                ...
                                switch(data.rows[i].deviceUserStatus) {
                                    case 0:
                                        data.rows[i].deviceUserStatus_text = '默认';
                                        break;
                                    case 1:
                                        data.rows[i].deviceUserStatus_text = '已绑定';
                                        break;
                                    case 2:
                                        data.rows[i].deviceUserStatus_text = '未绑定';
                                        break;
                                }
                            }
                            return data;
			...
			<tr><th data-options="field:'deviceid2',checkbox:true"></th><th data-options="field:'deviceid3',formatter: function(value,row,index){
				...
				<thead>
					...
					<tr>
                        ...
                        <th data-options="field:'useruid',sortable:true" width="100">账号</th>
                        <th data-options="field:'username',sortable:true" width="100">姓名</th>
                        <th data-options="field:'unitname',sortable:true" width="100">单位</th> 
                        <th data-options="field:'deviceid',sortable:true" width="270">设备号</th>
                        <th data-options="field:'status_text'" width="50">状态</th>
                        <th data-options="field:'deviceUserStatus_text'" width="60">设备绑定</th>
            ...
            <script type="text/javascript">
                ...
                function Search() {
                    ...
                    var deviceUserStatusCode = $('#selDeviceUserStatus').combobox('getValue');
                    if (deviceUserStatusCode == '')
                        deviceUserStatusCode = -1;
                    else
                        deviceUserStatusCode = parseInt(deviceUserStatusCode);
                    ...
                    $('#grid').datagrid('load', {
                        ...
                        status: statusCode,
                        deviceUserStatus: deviceUserStatusCode,
                        orderby: sortStr,
                        pageIndex: 0,
