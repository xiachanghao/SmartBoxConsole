...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:165px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>服务监控>>警报记录</span>
        </div>
...
<a id="btn_upload" onclick="javascript:return void();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">删除</a>
     ...
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetMonitorWarningList") %>',idField:'id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb'">
				<thead>
					<tr>
                        <th data-options="field:'sw_id',checkbox:true"></th>						
                        <%--<th data-options="field:'sw_log_id'" width="80">账号</th>--%>
                        <th data-options="field:'sw_senddate'" width="40">发送日期</th>
                        <th data-options="field:'sw_sendresult'" width="30">发送结果</th>
                        <th data-options="field:'sw_receptman'" width="30">接收人</th>
                        <th data-options="field:'sw_sendway'" width="30">发送方式</th>
                        <th data-options="field:'sw_createdate'" width="30">创建日期</th>
                        <th data-options="field:'sw_lastsenddate'" width="30">最后发送日期</th>
                        <th data-options="field:'sw_mobile'" width="30">手机号码</th>
                        <th data-options="field:'sw_email'" width="30">电子邮件</th>
						<th data-options="field:'swid',formatter: function(value,row,index){
				return '<a href=\'#\' onclick=\'javascript:return void('+value+');\'>查看</a>' + 
