...
<a id="btn_upload" onclick="javascript:return UploadDll();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">添加</a>
<a onclick="javascript:return DeleteDll();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除</a>
</div>
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetDeviceDisableAuthExceptionList") %>',idField:'pd_id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb'">
				<thead>
					<tr>
				...
				return '<a href=\'#\' onclick=\'javascript:return ModifyEntity('+value+');\'>添加</a>' + 
                '&nbsp;<a href=\'#\' onclick=\'javascript:return OperateDll('+value+',&quot;AddJobPluginGroup&quot;)\'>删除</a>' + 
