...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:227px;overflow:hidden;border:0px solid #DDDDDD;">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input id="Text5" name="tbTimeStart" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>-<input id="Text6" name="tbTimeEnd" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>
                    </td>
                    <td>
                        修改时间：
                    </td>
                    <td>
                        <input id="Text7" name="tbTimeStart" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>-<input id="Text8" name="tbTimeEnd" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="Text1" name="tbTimeStart" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>-<input id="Text2" name="tbTimeEnd" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>
                    </td>
                    <td>
                        解锁时间：
                    </td>
                    <td>
                        <input id="Text3" name="tbTimeStart" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>-<input id="Text4" name="tbTimeEnd" readonly="readonly"  type="text"  class="Wdate" onClick="WdatePicker()"/>
                    </td>
                </tr>
                <tfoot>
                    <tr>
...
<a id="btn_upload" onclick="javascript:return UploadDll();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">解除锁定</a>
<a onclick="javascript:return DeleteDll();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">锁定</a>
</div>
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetUserUnlockList") %>',idField:'pd_id',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:true,toolbar: '#tb'">
				<thead>
					<tr>
                        ...
                        <th data-options="field:'created_time'" width="50">创建时间</th>
                        <th data-options="field:'updated_time'" width="50">修改时间</th>
                        <th data-options="field:'lock_time'" width="50">锁定时间</th>
                        <th data-options="field:'unlock_time'" width="50">解锁时间</th>
                        <th data-options="field:'user_status'" width="30">状态</th>
						<th data-options="field:'pdid',formatter: function(value,row,index){
				return '<a href=\'#\' onclick=\'javascript:return ModifyEntity('+value+');\'>解除锁定</a>' + 
                '&nbsp;<a href=\'#\' onclick=\'javascript:return OperateDll('+value+',&quot;AddJobPluginGroup&quot;)\'>锁定</a>' + 
