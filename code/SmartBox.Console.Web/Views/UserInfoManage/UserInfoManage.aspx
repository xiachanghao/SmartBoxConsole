...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:163px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>用户管理>>在线用户</span>
        </div>
...
<a onclick="javascript:return KickoutSelected();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">退出登录</a>
     ...
     <table id="grid" class="easyui-datagrid" style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetUserInfoManageList") %>',idField:'U_ID',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:false,toolbar: '#tb',
                    loadFilter: function (data) {  
                        for (var i = 0; i < data.rows.length; ++i) {
                            ...
                            data.rows[i].Status2 = data.rows[i].Status;
			...
			<tr><th data-options="field:'U_ID',checkbox:true"></th><th data-options="field:'U_UID2',formatter: function(value,row,index){

				return '<a href=\'#\' onclick=\'javascript:return Kickout(&quot;'+row.U_UID+'&quot;,&quot;'+row.U_NAME+'&quot;);\'>退出登录</a>' + 
                '&nbsp;<a href=\'#\' onclick=\'javascript:return ViewDevice(&quot;'+row.U_UID+'&quot;)\'>查看设备</a>' + 
               ...
               '';
			}" width="120">操作</th></tr></thead>
				<thead>
					<tr>
                        
						<th data-options="field:'U_NAME'" width="120">姓名</th>
                        <th data-options="field:'U_UID'" width="120">账号</th>
                        <th data-options="field:'U_UnitName'" width="120">单位</th>
                        <%--<th data-options="field:'DeviceID'" width="280">设备ID</th>
                        <th data-options="field:'ClientType'" width="120">设备类型</th>--%>
                        <th data-options="field:'Status2',sortable:true" width="40">状态</th>
                        <th data-options="field:'lastusetime2',sortable:true" width="120">最后使用时间</th>
                        <th data-options="field:'LastLoginTime2'" width="120">最后登陆时间</th>
                        <th data-options="field:'LastLogoutTime2'" width="120">最后退出时间</th>
...
//                }
                ...
                function ViewDevice(uid) {
                    var url = '<%=Url.Content("~/") %>UserInfoManage/Userdeviceonline?uid=' + uid;
                    $('#wif')[0].src = url;
