<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IList<SmartBox.Console.Common.Entities.PluginInfo>>" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
         ...
         errorPlacement: function(error, element) {
            ...
            {  
             ...
             $("#tabs").height(maiheight-parent.$("#caltoolbar").outerHeight());
        ...
        function AddTr() {
            ...
            $("#tablist_"+pcode).append("<tr id='" + pcode + "tr" + counts + "'><td class='tdtop tdleft'><input type='text' name='"+ pcode + "|" + counts + ".Key1' /></td><td class='tdtop'><input type='text' name='"+ pcode + "|" + counts + ".Value1' /></td><td class='tdtop tdright'><a onclick=\"del('" + pcode + "tr" + counts + "')\" style='cursor:pointer;color:blue' >删除</a></td></tr>");
            counts++;
        }
...
<body id="bodyDiv">
    ...
    <div id="tabs" class="tabs">
        <div id="tabbody" class="tabsitemcontainer">
            <% using (Html.BeginForm("SaveConfigInfo", "PluginInfoManage", new { vid = ViewData["vid"] }, FormMethod.Post, new { id = "fmEdit" }))
               {
                ...
                <fieldset>
                    ...
                    <table width="100%" id="Table1" class="bbit-form" cellspacing="0" cellpadding="1">
                        <tr>
                            ...
                            <td class="bbit-form-cell-value tdtop ">
                                <%=Model[i].PluginCode%>
                                <%=Html.Hidden("s"+i.ToString()+".PluginCode",Model[i].PluginCode)%>
                            </td>
            ...
            <div id="Sd_<%=Model[i].PluginCode%>_c">
                <fieldset id="configDiv">
                    ...
                    <table width="100%" id="tablist_<%=Model[i].PluginCode%>" style="background-color: White" cellspacing="0"
                        cellpadding="1">
                        ...
                        <tr id="<%=Model[i].PluginCode%>tr<%=j%>">
                            ...
                            <td class="tdtop">
                                <%=Html.TextBox(Model[i].PluginCode + "|" + j.ToString() + ".Value1", list[j].Value1, new { style = "", Class = "" })%>
                            </td>
                            <td class="tdtop tdright">
                                <a onclick="del('<%=Model[i].PluginCode%>tr<%=j%>')" style='cursor: pointer; color: blue'>删除</a>
                            </td>
                        </tr>
                        <%} %>
                    </table>
    ...
    <div style="text-align: center">
        <input type="button" id="Butsubmit" value="保存并发布" style="width:70px" />
        <input type="button" id="btnclose" value="关 闭" onclick="javascript:CloseModelWindow(null, true);" style="width:70px" />
    </div>
</body>
</html>
