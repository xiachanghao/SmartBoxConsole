...
<body>
    <div>
        ...
        <div class="bbit-categorycontainer">
            <% using (Html.BeginForm("SaveFileInfo", "UpdaterManage", new { IsAdd = ViewData["IsAdd"], IsUpdate = ViewData["IsUpdate"] }, FormMethod.Post, new { id = "fmEdit", enctype = "multipart/form-data" }))
               {%>
