...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //校验
            $.validator.addMethod("safe", function(value, element) {return this.optional(element) || /^[^$\<\>\\\/]+$/.test(value);}, "不能包含特殊符号");
            ...
            $("#fmEdit").validate(
            {
                ...
                errorPlacement: function(error, element) {showerror(error, element);}
            });
