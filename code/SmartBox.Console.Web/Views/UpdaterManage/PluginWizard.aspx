...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var urls = '<%=Url.Action("UpdaterInfo") %>/?IsUpdate=' + IsUpdate + '&IsAdd=' + IsAdd + '&Vid=' + Vid + '&AddVid=' + AddVid;
            $("#ifm").attr("src", urls);
            ...
            function TreeNode_Click(data) {
                ...
                var url = "";
                if (id == "0") {
                    $("#dicInfoName").text("1.版本基本信息");
                    var url = '<%=Url.Action("UpdaterInfo") %>/?IsUpdate=' + IsUpdate + '&IsAdd=' + IsAdd + '&Vid=' + Vid + '&AddVid=' + AddVid;
                    $("#ifm").attr("src", url);
                }
                else if (id == "1") {
                    if (IsVersion == "")
            ...
            <tr>
                ...
                <td valign="top" >
                    <div id="cheadtop" class="cHead">
                        <div style="">
                            <span id="dicInfoName">1.版本基本信息</span>
                        </div>
                    </div>
                    <div>
