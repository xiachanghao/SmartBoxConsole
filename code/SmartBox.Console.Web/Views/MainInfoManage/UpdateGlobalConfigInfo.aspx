...
<body id="bodyDiv">
    ...
    <div id="InfoDiv" class="bbit-categorycontainer" style="display:none">
        <fieldset>
    ...
    <div id="tabs" class="tabs">
        <div id="tabbody" class="tabsitemcontainer">
            <% using (Html.BeginForm("SaveGlobalConfigInfo", "MainInfoManage", new { Vid = Model.VersionId }, FormMethod.Post, new { id = "fmEdit" }))
               {
                   var codes = "";
    ...
    <div style="text-align: center">
        <input type="button" id="Butsubmit" value="保 存" style="width:70px" />
