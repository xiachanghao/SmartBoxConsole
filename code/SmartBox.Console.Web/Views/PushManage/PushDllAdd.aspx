        ...
        <div class="table_box_data table_box_data_model_details">
            <table  cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <th width="30%">插件名称：</th>
                        <td class=""><input type="text" id="pd_name" name="pd_name" /><input type="hidden" name="pd_id" id="pd_id" /> </td>
                    </tr>
                    <tr>
                        <th>dll文件名称：</th>
                        <td><input type="text" id="pd_dll_filename" name="pd_dll_filename" readonly /> </td>
                    </tr>
                    <tr>
                        <th>job配置文件名称：</th>
                        <td><input type="text" id="pd_xml_filename" name="pd_xml_filename" readonly /> </td>
                    </tr>
                    <tr>
                        <th>附件：</th>
