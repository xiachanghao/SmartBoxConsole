<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<SmartBox.Console.Common.Entities.SMC_PackageManual>" %>
    ...
    <script language="javascript" type="text/javascript">
        $("document").ready(function () {
            ...
            $("a#Save").click(function () {
                $("#frmPackageManual").submit();
            });


            //上传之验证
            $("#frmPackageManual").validate({
                rules: {
                    packageUpload: { required: true }
                },
                messages: {
                    packageUpload: { required: "请选择要上传的手册文件!" }
                },
                submitHandler: function (form) {
                    $("#frmPackageManual").ajaxSubmit({
...
<body>
    ...
    <fieldset>
        <legend>手册修改</legend>
        <% using (Html.BeginForm("ModifyPackageManual", "ApplicationManage", FormMethod.Post, new { id = "frmPackageManual", enctype = "multipart/form-data" }))
           { %>
        ...
        <table class="sp-form" width="100%" cellspacing="1" cellpadding="0">           
            <tr style="display:none">
                    ...
                    <td class="sp-form-cell-value">
                        <%= Html.TextBox("pm_id", ViewData["id"], new { @Style = "width:75%;", @Class = "DisplayName" })%>
                    </td>
              </tr>
             <tr>
                    <td class="sp-form-cell-name">
                    ...
                    <td class="sp-form-cell-value">
                        <%= Html.TextBox("pm_name", Model.pm_name, new { @Style = "width:75%;", @Class = "DisplayName" })%>
                    </td>
              </tr>              
        </table>
        <%} %>
