...
<body>
    ...
    <fieldset>
        <legend>手册上传</legend>
        <% using (Html.BeginForm("CreatePackageManual", "ApplicationManage", FormMethod.Post, new { id = "frmPackageManual", enctype = "multipart/form-data" }))
           { %>
        ...
        <table class="sp-form" width="100%" cellspacing="1" cellpadding="0">
            ...
            <tr style="display:none">
             ...
             <tr>
                    ...
                    <td class="sp-form-cell-value">
                        <%= Html.TextBox("pm_name", "", new { @Style = "width:75%;", @Class = "DisplayName" })%>
                    </td>
              </tr>              
        </table>
        <%} %>
