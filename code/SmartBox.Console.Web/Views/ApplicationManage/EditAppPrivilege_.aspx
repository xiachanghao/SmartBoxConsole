<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<SmartBox.Console.Common.Entities.AppPrivilege>" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        $("document").ready(function () {
            ...
            //保存之验证
            $("#frmAppPrivilegeInfo").validate({
                rules: {
                    Name: { required: true },
                    DisplayName: { required: true },
                    BuaAppCode: { required: true },
                    BuaPrivilegeCode: { required: true }
                },
                messages: {
                    Name: { required: "请填写权限标识！" },
                    DisplayName: { required: "请填写显示名称！" },
                    BuaAppCode: { required: "请填写Bua应用系统标识！" },
                    BuaPrivilegeCode: { required: "请填写Bua权限标识！" }
                },
                submitHandler: function (form) {
                    $("#frmAppPrivilegeInfo").ajaxSubmit(saveoptions);
                },
                errorElement: "div",
...
<body>
    ...
    <% using (Html.BeginForm("EditAppPrivilege", "ApplicationManage", FormMethod.Post, new { id = "frmAppPrivilegeInfo" }))
       {
    ...
    <table class="bbit-form" width="100%" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%=Html.TextBox("BuaAppCode", Model.BuaAppCode)%>
            </td>
        </tr>
        <tr>
            <td class="bbit-form-cell-name tdtop tdleft tdright">
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%=Html.TextBox("BuaPrivilegeCode", Model.BuaPrivilegeCode)%>
            </td>
        </tr>
        <tr>
            <td class="bbit-form-cell-name tdtop tdleft tdright">
            ...
            <td class="bbit-form-cell-value tdtop tdright" colspan="3">
                <%=Html.RadioButton("EnableSync", true, Model.EnableSync, new { @id = "enableSync" })%><label for="enableSync">启用</label>
                <%=Html.RadioButton("EnableSync", false, !Model.EnableSync, new { @id="disableSync" })%><label for="disableSync">禁用</label>
            </td>
        </tr>
        <tr>
            <td class="bbit-form-cell-name tdtop tdleft tdright">
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%=Html.TextBox("SyncIntervalTime",Model.SyncIntervalTime)%>
            </td>
        </tr>
    </table>
    <%= Html.Hidden("ID", Model.ID)%>
    <%= Html.Hidden("SyncLastTime", Model.SyncLastTime)%>
    <%= Html.Hidden("SyncTime", Model.SyncTime)%>
