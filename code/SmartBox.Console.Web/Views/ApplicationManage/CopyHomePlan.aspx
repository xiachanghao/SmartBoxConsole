    ...
    <script language="javascript" type="text/javascript">
        $("document").ready(function () {
            ...
            if ($("#Format").val() != "") {
                ...
                $("#pageW").val(tempFormat[0]);
                $("#pageH").val(tempFormat[1]);
            }
        });
    </script>
</head>
<body>
    ...
    <% using (Html.BeginForm("CopyHomePlan", "ApplicationManage", FormMethod.Post, new { id = "frmApplicationInfo" }))
       {
    ...
    <table class="bbit-form" width="100%" cellspacing="1" cellpadding="0">
        <tr>
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%= Html.TextBox("Code", "", new { @Style = "width:95%;", @Class = "Code" })%>
        ...
        <tr>
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%= Html.TextBox("DisplayName", "", new { @Style = "width:95%;", @Class = "DisplayName" })%>
            </td>
        </tr>
        <tr>
            <td class="bbit-form-cell-name tdtop tdleft tdright">
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%= Html.RadioButton("IsDefault", true, false, new { @id = "rdoEnable" })%><label
                    for="rdoEnable">是</label>
                <%= Html.RadioButton("IsDefault", false, true, new { @id = "rdoDesable" })%><label
        ...
        <tr>
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                宽:<%= Html.TextBox("pageW", null, new { @Style="width:30px;",@Readonly="readonly" })%>&nbsp;高:<%= Html.TextBox("pageH", null, new { @Style = "width:30px;", @Readonly = "readonly" })%>
