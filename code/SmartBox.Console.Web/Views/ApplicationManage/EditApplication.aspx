<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<SmartBox.Console.Common.Entities.Application>" %>
...
<body>
    ...
    <table class="bbit-form" width="100%" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                ...
                <%= Html.RadioButton("Enable",false, !Model.Enable, new { @id = "rdoDesable"})%><label
            ...
            <td class="bbit-form-cell-value tdtop tdright">
                <%=Html.DropDownListFor(model => Model.EnableType,
                                        new List<SelectListItem>() { 
                                            new SelectListItem() { Text = "必要", Value = "Need" },
                                            new SelectListItem() { Text= "默认开启", Value="DefaultTrue" },
                                            new SelectListItem() { Text= "默认关闭", Value="DefaultFalse" }
                                        },
        ...
        <tr style="display:none;">
            ...
            <td class="bbit-form-cell-value tdtop tdright" colspan="3">
                <%=Html.DropDownListFor(model => Model.PrivilegeID,
                                        ViewData["Privilege"] as IList<SelectListItem>,
                                        new { @id = "PrivilegeID", @name = "PrivilegeID", @Class = "PrivilegeID" })%>
            </td>
        </tr>
        <tr>
            <td class="bbit-form-cell-name tdtop tdleft tdright">
    ...
    <%= Html.Hidden("CategoryIDs", Model.CategoryIDs)%>
    <% } %>
</body>
</html>
