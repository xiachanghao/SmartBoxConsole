    ...
    <script language="javascript" type="text/javascript">
        function loadData() {
            ...
            var option = {
                height: gh,
                width: mainWidth,
                url: '<%=Url.Action("QueryAsyncResultListBUAUserToOutside")%>?sync_bat_no=<%=Request.QueryString["sync_bat_no"]%>&sync_time_start=<%=Request.QueryString["sync_time_start"]%>&sync_time_end=<%=Request.QueryString["sync_time_end"]%>&sync_status=<%=Request.QueryString["sync_status"]%>&userName=' + userName,
                colModel: [
        ...
        $("document").ready(function () {
            ...
            $('div#Search').click(function () {
                ...
                var url = '<%=Url.Content("~/ApplicationManage/AsyncResultListBUAUserToOutside")%>?sync_bat_no=' + batNo + '&userName=' + userName + '&sync_status=' + sync_status + '&sync_time_start=' + sync_time_start + '&sync_time_end=' + sync_time_end;
                window.location = url;
            });
            ...
            $("div#Save").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=Url.Action("DeleteBUAUserAsyncToOutsideResult") %>',
                    data: { ids: ids },
                    dataType: "json",
...
<body>
    ...
    <div class="cHead">
            <div class="ftitle">
                <span id="departmentName">BUA用户同步外网结果查询</span>
            </div>
        </div> 
