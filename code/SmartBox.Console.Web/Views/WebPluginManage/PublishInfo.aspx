        ...
        $(document).ready(function() {
            ...
            var options = {
                ...
                success: function(data) {
                    $("#loadingpannel").hide();
                    if (data.IsSuccess) {
                        hiAlert(data.Msg, '提示', function() { window.location = '<%=Url.Action("WebPluginVersionList") %>'; });
                    }
                    else {
                        hiAlert("操作失败，可能的原因:\r\n" + data.Msg, '提示');
                    }
...
<body>
    <div>
        ...
        <% using (Html.BeginForm("Publishs", "WebPluginManage", FormMethod.Post, new { id = "fmEdit" }))
           {%>
