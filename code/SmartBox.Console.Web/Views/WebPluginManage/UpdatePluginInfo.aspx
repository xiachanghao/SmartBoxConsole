            ...
            $("#fmEdit").validate(
             {
                 rules: {
                     ...
                     ActionCode: { maxlength: 64 },
                     VersionName: { required: true, maxlength: 100 }
                 },
                 messages: {
                     DisplayName: { required: "插件名不能为空" },
                     VersionName: { required: "版本号不能为空" }
                 },
...
<body>
    <div>
        ...
        <div class="bbit-categorycontainer">
            <% using (Html.BeginForm("SavePluginInfo", "WebPluginManage", new { isAdd = ViewData["isAdd"] }, FormMethod.Post, new { id = "fmEdit" }))
               {
            ...
            <fieldset>
                <legend class="title">web插件基本信息</legend>
                <table width="100%" id="basicinfotable" class="bbit-form" cellspacing="0" cellpadding="1">
                    ...
                    <tr>
                        ...
                        <td class="bbit-form-cell-value tdtop">
                            <%=Html.TextBox("PluginUrl", Model.PluginUrl, new { style = "width:280px"})%>
                        </td>
                        <td class="bbit-form-cell-name tdtop">
                            <label>
                                排序号：</label>
                        ...
                        <td class="bbit-form-cell-value tdtop tdright">
                            <%=Html.TextBox("Sequence", Model.Sequence, new { style = "width:20%", Class = "digits" })%>
                        </td>
                    </tr>
                    <tr>
                        <td class="bbit-form-cell-name tdtop tdleft">
            ...
            <fieldset style="display:none">
                <legend class="title">web插件扩展信息</legend>
                <table width="100%" id="Table1" class="bbit-form" cellspacing="0" cellpadding="1">
                    <tr>
                        ...
                        <td class="bbit-form-cell-value tdtop">
                            <%=Html.TextBox("ActionCode", ViewData["actionCode"], new { Class = "safe" })%>
                        </td>
                    </tr>
                    <tr>
                    <td class="bbit-form-cell-name tdtop">
             ...
             <fieldset>
                <legend class="title">web插件版本信息</legend>
                <table width="100%" id="Table3" class="bbit-form" cellspacing="0" cellpadding="1">
                    <tr>
                        ...
                        <td class="bbit-form-cell-value tdtop tdright">
                            <%=Html.TextBox("VersionName", ViewData["vername"], new { Class = "required safe" })%>
                            <span class="bbit-formItemMust">*</span>
                        </td>
                    </tr>
                </table>
