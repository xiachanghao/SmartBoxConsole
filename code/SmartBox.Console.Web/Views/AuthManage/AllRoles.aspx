    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var option = {
                height: gh,
                width: mainWidth,
                url: '<%=Url.Action("GetAllRoles")%>?UnitID=' + escape(unitId),
                colModel: [
                    { display: '角色名称', name: 'Role_Name', width: 80, sortable: false, process: Dclick, align: 'left' },
                    { display: '排序号', name: 'Role_Sequence', width: 80, sortable: false, align: 'left' },
                    { display: '备注', name: 'Role_Demo', width: 80, sortable: false, align: 'left' },
			        { display: '发布时间', name: 'Role_CreatedTime', width: 130, sortable: false, hide: true, align: 'left' }
				],

                sortname: "Role_CreatedTime",
                sortorder: "desc",
                usepager: true,
                rp: 15,
                rowbinddata: true,
