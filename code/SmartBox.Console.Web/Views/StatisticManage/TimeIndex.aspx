...
<div id="_layout" class="easyui-layout" data-options="fit:true" style="">
    <div data-options="region:'north',split:false" style="height:163px;overflow:hidden;border:0px solid #DDDDDD;">
        <div class="easyui-panel cHead" data-options="" style="display:;font-size:12px;color:#528FB6;text-align: left; border:1px solid #DDDDDD;padding-left:5px;">
            <img src="../../themes/default/images/flexigrid/grid.png" /><span>统计管理>>用户在线时长</span>
        </div>
...
<a onclick="javascript:return void();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">解除绑定</a>--%>
     ...
     <table id="grid" class="easyui-datagrid" sortName=losttime sortOrder=desc style="width:100%;border-top:1px solid #DDDDDD"
					data-options="url:'<%=Url.Content("~/Demo/GetTimeIndex") %>',idField:'deviceid',method:'get',displayMsg:'当前{from}-{to}，共 {total}',loadMsg:'正在加载...',rownumbers:true,checkOnSelect:false,selectOnCheck:true,singleSelect:false,pagination:true,border:false,fit:true,fitColumns:false,toolbar: '#tb',loadFilter: function (data) {
			...
			<tr><th data-options="field:'deviceid2',checkbox:true"></th><th data-options="hidden:true,field:'deviceid3',formatter: function(value,row,index){
				...
				<thead>
					...
					<tr>
                        ...
                        <th data-options="field:'User_Full_Name',sortable:true" width="140">姓名</th>
                        <th data-options="field:'ORG_NAME',sortable:true" width="180">单位</th> 
                        <th data-options="field:'PhoneAndroid',sortable:true" width="140">Phone/Android(小时)</th>
                        <th data-options="field:'PadAndroid',sortable:true" width="120">Pad/Android(小时)</th>
                        <th data-options="field:'PhoneiOS',sortable:true" width="120">Phone/iOS(小时)</th>
            ...
            <script type="text/javascript">
                var sortStr = 'PhoneAndroid desc,PadAndroid desc,PhoneiOS desc,PadiOS desc';
