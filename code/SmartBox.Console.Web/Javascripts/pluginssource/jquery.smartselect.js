...
(function($) {
    ...
    $.fn.smartselect = function(o) {
        var options = $.extend({
            ...
            rp: 5,
            page: 1,
            title: [{ head: "标题1", width: "100px" }, { head: "标题2", width: "100px"}],
            autoheight: true,
            callback: false
        }, o);
        var me = $(this);
        ...
        var d = $("<div/>").addClass(options.containerCssClass).addClass("bbit-smartselect-grid")
                           ...
                           .appendTo($("body"));
        var gridcontainer = $("<div class='gridcontainer'/>").css({ width: options.dropwidth, height: options.dropheight - 32 });
        d.append(gridcontainer);
        //  var pagehtml = '<div class="pDiv2"><div class="pGroup"><div class="pFirst pButton" title="转到第一页"><span></span></div><div class="pPrev pButton" title="转到上一页"><span></span></div> </div><div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">当前 <input type="text" size="1" value="1" /> ,总页数 <span> 1 </span></span></div><div class="btnseparator"></div><div class="pGroup"> <div class="pNext pButton" title="转到下一页"><span></span></div><div class="pLast pButton" title="转到最后一页"><span></span></div></div><div class="btnseparator"></div><div class="pGroup"> <div class="pReload pButton" title="刷新"><span></span></div> </div> <div class="btnseparator"></div><div class="pGroup"><span class="pPageStat"></span></div></div>';
        var pagehtml = '<div class="pDiv2" style="margin:0 auto; width:90%;"><div class="pGroup"><div class="pFirst pButton" title="转到第一页"><span></span></div><div class="pPrev pButton" title="转到上一页"><span></span></div> </div><div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">当前 <input type="text" size="1" value="1" /> ,总页数 <span> 1 </span></span></div><div class="btnseparator"></div><div class="pGroup"> <div class="pNext pButton" title="转到下一页"><span></span></div><div class="pLast pButton" title="转到最后一页"><span></span></div></div><div class="pGroup"><span class="pPageStat"></span></div></div>';
        ...
        if ($.browser.msie) {
            if (parseFloat($.browser.version) <= 6) {
                //var ie6hack = $("<div/>").css({ position: "absolute", "z-index": "-2", "overflow": "hidden", "height": "140px", width: "100%" });
        ...
        function addData(data) {
            ...
            var table = $("<table class='grid'/>").css({ width: options.dropwidth });
